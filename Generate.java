...
class Generate
{
    ...
    public void R(int ruleNo)
    {
        ...
        switch(ruleNo)
        {
            ...
            // R42 : buat instruksi untuk kembali dari prosedure
            case 42:
            ...
            // R44 : construct instructions call a procedure
            case 44:
                procAddress = Context.symbolHash.find(Context.currentStr).getAddress();

                HMachine.memory[cell] = HMachine.PUSH;
                HMachine.memory[cell+1] = cell + 5;
                HMachine.memory[cell+2] = HMachine.PUSH;
                HMachine.memory[cell+3] = procAddress;
                HMachine.memory[cell+4] = HMachine.BR;

                cell = cell + 5;
                break;

            // R47 : construct instructions call a function
            case 47:
                funcAddress = Context.symbolHash.find(Context.currentStr).getAddress();

                HMachine.memory[cell] = HMachine.PUSH;
                HMachine.memory[cell+1] = cell + 5;
                HMachine.memory[cell+2] = HMachine.PUSH;
                HMachine.memory[cell+3] = funcAddress;
                HMachine.memory[cell+4] = HMachine.BR;
