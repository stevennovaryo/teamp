            ...
            case 28:
                switch (symbolHash.find((String)symbolStack.peek()).getIdKind())
                {
                    ...
                    case Bucket.UNDEFINED:
                        ...
                        break;
                    default:
                        System.out.println("Procedure identifier expected at line " + currentLine + ": " + currentStr);
                        errorCount++;
                        break;
                }
                break;
            case 29:
                if (symbolHash.find((String)symbolStack.peek()).getParameterCount() != 0)
                {
                    System.out.println("Procedure with no parameter expected at line " + currentLine + ": " + currentStr);
                    errorCount++;
                    break;
                }
                break;
            case 33:
                switch (symbolHash.find((String)symbolStack.peek()).getIdKind())
                {
                    ...
                    case Bucket.UNDEFINED:
                        ...
                        break;
                    default:
                        System.out.println("Function identifier expected at line " + currentLine + ": " + currentStr);
                        errorCount++;
                        break;
                }
                break;
            case 36:
                int expressionType = (((Integer)typeStack.pop()).intValue());
                int funcType = (((Integer)typeStack.peek()).intValue());
                if (expressionType != funcType) {
                    System.out.println("Unmatched type at line " + currentLine + ": " + currentStr);
                    errorCount++;
                break;
            case 37:
